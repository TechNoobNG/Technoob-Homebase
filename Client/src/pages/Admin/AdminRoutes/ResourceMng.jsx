...
const ResourceMng = () => {
  ...
  useEffect(() => {
    fetchFirstData("/resources/activity", setResourceActivity, null, true, "activity").then((_r) =>
      setIsLoading(false)
    );
  ...
  return (
    <section className={`w-full overflow-hidden ${isModalOpen ? "overflow-hidden" : ""} min-h-screen`}>
      ...
      <div className="lg:p-5 md:rounded-md bg-white h-full xl:shadow-md w-full">
        <div className="w-full h-full">
                ...
                statsMap.map((opt, i) => (
                  <div key={i} className=" px-3 pt-5 pb-6 rounded-lg w-[25rem] shadow-md lg:w-[40%] lg:mr-3 ">
                    ...
                    <div className="flex justify-start items-end w-full">
                      <p className="p-2 mr-6 text-xl">{`${opt.amount} ${opt.amtlabel}`} </p>
          ...
          <Modal isOpen={isModalOpen} closeModal={closeModal} setIsModalOpen={setIsModalOpen}>
          ...
          <div className="mt-16">
            <div className=" flex justify-between">
              <div>
                ...
                <p className=" text-lg text-[#747272] mb-1">See list of recently uploaded resources.</p>
              </div>
