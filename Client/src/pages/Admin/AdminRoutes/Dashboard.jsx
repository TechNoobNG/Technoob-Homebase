      ...
      <div className=" lg:mx-5 px-10 py-5 rounded-xl bg-white w-full pb-20 ">
        ...
        <div className=" md:flex block w-full justify-between pb-3 ">
          {statistics.map((opt, i) => (
            <div key={i} className=" p-3 shadow-md rounded-md my-2 mx-2 lg:w-[80%] lg:h-auto">
              <p className=" py-3 px-2 flex text-[#71717A] justify-between w-[auto]">
                {opt.name}
                <span className={`${opt.style} rounded-full p-2`}>{opt.icon}</span>{" "}
              </p>
              <p className=" p-2">
                <span className=" font-bold text-xl">{opt.amount}</span> {opt.amtlabel}{" "}
              </p>
        ...
        <div className=" flex py-10 border-t-2 border-b-2">
          ...
          <span className=" border ml-14 p-2 rounded-full bg-[#bbc5e780]">
            <button
              className=" bg-[#5E7CE880] text-twhite p-2 rounded-full border w-[120px] hover:bg-[#5E7CE880] hover:text-twhite shadow
              "
            >
              Last Year
            </button>{" "}
            <button
              className=" p-2 rounded-full border bg-twhite w-[120px] hover:bg-[#5E7CE880] hover:text-twhite
              "
            >
              6 Months
            </button>{" "}
