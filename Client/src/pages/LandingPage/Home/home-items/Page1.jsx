      ...
      <div className="flex flex-col justify-start w-full items-start px-4 sm:justify-center sm:items-center">
        ...
        <div className="w-[290px] sm:w-[712px]  sm:m-4 mb-7 ">
          <h4 className="text-xs text-[#3a3a3a] tracking-[0.015px] leading-4 sm:text-2xl sm:text-center">
            Join our community of tech newbies with resources and great initiatives from Technoob to help navigate the
            muddled tech space. Network with newbies and mentors and find great job opportunities curated solely for
            you.
          </h4>
        </div>
