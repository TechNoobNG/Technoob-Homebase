     ...
     <div className="flex  justify-center px-5 lg:px-48 pb-20">
       <div className="flex flex-col justify-center w-full ">
         ...
         <p className="nun text-xl font-normal w-auto lg:pr-48 py-3">
           We have an array of events and workshops planned and we need all the
           help we can get, if you like to partner with us or sponsor an event,
           we would be glad.
         </p>
         <button
       ...
       <div className="pb-20">
         <img
           src={partnership}
           alt=""
           className="lg:flex w-[900px] h-auto hidden"
         />
       </div>
     </div>
   );
