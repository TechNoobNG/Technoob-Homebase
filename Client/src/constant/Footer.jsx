...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col justify-center p-5 sm:p-10 items-center bg-[#3A3A3A] text-[#F5EFFB] h-[300px] w-full sm:h-[300px]">
      ...
      <div className="mt-[50px] sm:mt-[90px] sm:flex flex-col justify-center items-center w-full">
        ...
        <div className="flex flex-row flex-wrap mb-5">
          {footerItems.map((footerItem, i) => (
            <div
              key={i}
              className={`flex ${i !== footerItem.length - 1 ? "mr-4" : "mr-0"}  items-center justify-center`}
            >
        ...
        <p className="text-sm">© Copyright 2023 TechNoob. All Rights Reserved.</p>
      </div>
    </div>
  );
};
