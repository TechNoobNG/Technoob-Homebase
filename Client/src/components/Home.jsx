        ...
        <div className="flex flex-col justify-start w-full items-start sm:justify-center sm:items-center sm:mb-10">
          <div className="w-[720px] flex flex-col relative sm:mb-4">
            <img
              src={HeroText}
              alt="hero-text"
              className="w-[280px] m-4  h-[29px] sm:w-[720px] sm:h-[77px] mb-1 "
            />
            <img
              src={Vector1}
              alt="scrb"
              className="hidden lg:flex w-[242px] absolute right-10 top-[85px]"
            />
          </div>
          <div className="w-[290px] sm:w-[712px] m-4 mb-7">
            <h4 className="text-xs text-[#3a3a3a] tracking-[0.015px] leading-4 sm:text-2xl sm:text-center">
              Join our community of tech newbies with resources and great
              initiatives from Technoob to help navigate the muddled tech space.
              Network with newbies and mentors and find great job opportunities
              curated solely for you.
            </h4>
          </div>
