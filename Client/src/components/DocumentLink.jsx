        ...
        <div className="flex flex-col gap-4">
          <div>
            <label htmlFor="textarea" className="text-xl">
              File Description <span className="text-sm ml-6 text-slate-400">Optional</span>
            </label>
            <textarea
              name="text"
              id="text"
              ...
              className="text-xl placeholder:text-gray-400 text-slate-500 "
            ></textarea>
          </div>
          <div className="flex flex-col justify-start items-start">
            ...
            <input
              type="text"
              id="documentLink"
              className="text-xl placeholder:text-gray-400 text-slate-500 px-2 py-3"
            />
          </div>
